...
# Añade esta instancia al final de tu código para probarlo
example_sentence = "This is an example sentence. It contains words, words, and more words!"

# Crea una instancia de la clase WordCloudData
word_cloud_data = WordCloudData(example_sentence)

# Imprime la propiedad words_to_counts
print(word_cloud_data.words_to_counts)